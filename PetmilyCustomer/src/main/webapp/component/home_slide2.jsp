...
<body>
	...
	<!-- 슬라이드 2번째화면 강아지 고양이 etc선택하는것(카드) -->
			...
			<div class="row">
				...
				<div class="col-12 text-center">
					...
					<div class="btn-group mx-auto mb-2" role="group"
						...
						<button type="button" class="btn btn-outline-dark clicked">Dogs</button>
						<button type="button" class="btn btn-outline-dark">Cats</button>
					...
					<div
						...
						<div class="col">
							<div class="card h-100 shadow-sm">
								<img
									src="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/57701890/1/?bust=1667553993&width=316"
									class="card-img-top" alt="...">
								<div class="label-top shadow-sm">DELL</div>
								<div class="card-body">
									<div class="clearfix mb-3">
										<span style="color: #55BCD6; font-weight: 800;font-size: 24px; ">견종</span> 
									</div>
									<h5 class="card-title"> 설명란 </h5>
	...
	<jsp:include page="home_slide3.jsp"></jsp:include>
	<jsp:include page="home_slide5.jsp"></jsp:include>
