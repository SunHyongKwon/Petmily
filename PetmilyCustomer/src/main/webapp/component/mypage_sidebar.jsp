<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<ul class="nav flex-column">
	  ...
	  <li class="nav-item my-2"> 
	    <a class="nav-link" href="mypage_modify_login.do" style="color:black;"><p class="h5">개인정보 수정</p></a>
	  </li>
	  
	  <li class="nav-item my-2">
	   <a class="nav-link" href="mypage_challenge.do" style="color:black;"><p class="h5">도전과제 목록</p></a>
	  </li>
