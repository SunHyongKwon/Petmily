...
<body >
	...
	<!-- slide3 -->
	<div class="container mb-15" style="background-color: #E9F0FF;width: 1280px;
height: 743px;" >
	  <div class="row">
	    <div class="col">
	      지도 들어갈곳
	    ...
	    <div class="col">
	    	...
	    	<h1 class="display-1 mt-10 mb-2">우리동네<br> 유기견 보호소</h1>
	    	<h2>근처 유기견 보호소를 확인해요</h2>
	    	
	    	<div class="row mt-3">
	    		<div class="col">
	    			<img alt=".." src="images/homevolunteer.png">
