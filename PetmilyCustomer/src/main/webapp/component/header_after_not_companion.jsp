...
<body>
	<nav class="navbar navbar-expand-lg shadow-sm">
		<div class="container-fluid">
			<img src="images/logo.png" style="padding-right: 0.7rem; width : 55px; height : 50px;"><a
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav mx-auto">
					...
					<li class="nav-item"><a class="nav-link mx-3" href="#" style = "color : black;">로그인</a>
					</li>

					<li class="nav-item"><a class="nav-link mx-3" href="#" style = "color : black;">회원가입</a>
					</li>
				</ul>
			</div>
		</div>
