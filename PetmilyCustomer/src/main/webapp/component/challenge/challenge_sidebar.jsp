...
<body>
	...
	<div class="container d-md-flex align-items-stretch">
		...
		<nav id="sidebar">
			<div class="p-4 pt-5">
				<h5 style = "color : #de6637;"><strong>도전 목록</strong></h5>
				<ul class="list-unstyled components mb-5">
					<li><a href="#pageSubmenu1" data-toggle="collapse"
						aria-expanded="false" class="dropdown-toggle">Step1. 배변훈련 
						<!-- 아직 다 안 봤을 때 -->
					...
					<li><a href="#pageSubmenu2" data-toggle="collapse"
						aria-expanded="false" class="dropdown-toggle">Step2. 배변훈련
						<!-- 아직 다 안 봤을 때 -->
						<i class="bi bi-x-circle p-2"></i>
						<!-- 해당 스텝 다 봤을 때 -->
						<!-- <i class="bi bi-check-circle p-2"></i> -->
					...
					<li><a href="#pageSubmenu3" data-toggle="collapse"
						aria-expanded="false" class="dropdown-toggle">Step3. 배변훈련
						<!-- 아직 다 안 봤을 때 -->
						<i class="bi bi-x-circle p-2"></i> 
						<!-- 해당 스텝 다 봤을 때 -->
						<!-- <i class="bi bi-check-circle p-2"></i> -->
					...
					<li><a href="#pageSubmenu4" data-toggle="collapse"
						aria-expanded="false" class="dropdown-toggle">Step4. 봉사활동
						<!-- 아직 다 안 봤을 때 -->
						<i class="bi bi-x-circle p-2"></i>
						<!-- 해당 스텝 다 봤을 때 -->
						<!-- <i class="bi bi-check-circle p-2"></i> -->
