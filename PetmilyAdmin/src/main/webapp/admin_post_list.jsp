        ...
        <ul class="nav">
          ...
          <li class="nav-item sidebar-actions">
            <span class="nav-link">
              ...
              <button class="btn btn-block mt-4" style="background: #ffa500;">+ Add a project</button>
              <div class="mt-4">
                <div class="border-bottom">
...
<!-- dropdown[S] -->
  <div class="dropdown table margin_bt20" align="left">
    <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">카테고리</button>
    ...
    <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">지역별</button>
    <ul class="dropdown-menu">
      <li><a href="#">서울시</a></li>
      <li class="divider"></li>
      <li><a href="#">경기도</a></li>
