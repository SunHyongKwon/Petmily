...
public class NoticeDAO {
	...
	//
	public ArrayList<NoticeDTO> noticecategoryList(String ncategory) {
		...
		while (resultSet.next()) {
			...
			NoticeDTO dto = new NoticeDTO(nid, ntitle, ncontent, nimage1, nimage2, nimage3, ncategory, nlocation);
			dtos.add(dto);
			}	
