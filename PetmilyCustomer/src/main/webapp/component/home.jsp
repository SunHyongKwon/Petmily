...
<body>
	...
	<main>
		...
		<nav class="navbar navbar-expand-lg shadow-sm" style="
		padding-top: 11px;
    	padding-bottom: 11px;">
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav mx-auto">
						...
						<li class="nav-item"><a class="nav-link" href="contact.html">함께</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="contact.html">게시판</a>
						</li>
					</ul>

					<div class="d-none d-lg-block" >
						<a href="sign-in.html" class="bi-person " style="margin-right: 5px;">로그인</a> 
						<a href="product-detail.html" class="bi-bag " style="margin-right: 5px;"></a>
						<a href="product-detail.html" class="bi-heart "></a>
					</div>
				</div>
			</div>
		</nav>
		
			<section class="slick-slideshow" style="
    margin-top: 64px;
    height: 515px;
			">
                 <div class="slick-custom">
                    ...
                    <div class="slick-bottom">
                        <div class="container text-center">
                            <div class="row">
                                <div class="col-12">
                                    <h1 class="slick-title">애완동물은 가족입니다</h1><br>
                                    <a href="about.html" class="btn custom-btn">cat</a>
                                    <a href="about.html" class="btn custom-btn"></a>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                              <h2 class="mb-5">알면 알수록 쓸모있는 <span>펫과사전</span></h2>
                        </div>
